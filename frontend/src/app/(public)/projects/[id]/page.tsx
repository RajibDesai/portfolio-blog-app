...
// 🧠 পেজটি প্রতি ৬০ সেকেন্ড পর রিভ্যালিডেট হবে (ISR)
export const revalidate = 60;

/**
 * 🔹 Build-time এ প্রি-জেনারেট করার জন্য static params তৈরি
 * এতে popular / recent প্রজেক্টগুলো SSG হবে, বাকিগুলো ISR এ runtime এ তৈরি হবে।
 */
export async function generateStaticParams() {
  try {
    ...
    // প্রতিটি প্রজেক্টের ID দিয়ে static path তৈরি করা হচ্ছে
...
/**
 * 🔹 ISR Cache সহ প্রজেক্টের বিস্তারিত তথ্য ফেচ করা
 */
...
/**
 * 🔹 Project Details Page — ISR + SSG hybrid
 */
...
export default async function ProjectDetailsPage({
  ...
  return (
    <article className="max-w-4xl mx-auto p-4 md:p-8">
      {/* Title */}
      <h1 className="text-4xl font-extrabold mb-6 text-gray-800 border-b pb-2">
        {project.title}
      </h1>
